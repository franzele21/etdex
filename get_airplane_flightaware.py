...
airplane_data = to_dict_by_callsign(content["positions"], "fa_flight_id", "latitude", "longitude", "heading", "altitude", "groundspeed", "timestamp")
